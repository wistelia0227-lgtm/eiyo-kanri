...
const FILES = [
  ...
  './js/foods_data.js', './js/nutri.js', './js/foodgroup.js', './js/amounts.js', './js/xlsx.js',
  ...
  './modules/jisshi.js', './modules/stock.js', './modules/choice.js', './modules/poster.js', './modules/intake.js', './modules/needs.js', './modules/kondate.js', './modules/report.js', './modules/journal.js',
